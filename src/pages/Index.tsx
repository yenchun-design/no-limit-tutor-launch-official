...
{/* CTA Card - 招募老師（配色對齊圖一） */}
<div className="mb-8 md:mb-12">
  <Card className="border-4 border-black bg-gradient-to-r from-amber-400 via-orange-400 to-amber-500 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all duration-300 transform hover:-translate-x-1 hover:-translate-y-1">
    <CardContent className="p-4 md:p-8 text-center">
      {/* 主標：深棕＋白邊陰影，強烈層次 */}
      <h2 className="text-3xl md:text-5xl font-black text-[#4E2B16] mb-2 md:mb-4 drop-shadow-[3px_3px_0px_rgba(255,255,255,1)] tracking-tight">
        招募 2026 年線上家教老師中！
      </h2>

      {/* 副文：白底黑邊訊息條，底部粗線強化 */}
      <div className="inline-block bg-white border-2 md:border-3 border-black px-3 py-2 md:px-5 md:py-3 mb-4 md:mb-6 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
        <p className="text-sm md:text-lg font-black text-black">
          台灣首個民主、群眾導向的線上視訊一對一家教平台！
        </p>
      </div>
      <div className="mx-auto w-40 md:w-64 h-1.5 md:h-2 bg-black mb-4 md:mb-6" />

      {/* 行動按鈕：黑底白字，品牌粗邊風格 */}
      <Button
        asChild
        size="lg"
        className="bg-black hover:bg-gray-900 text-white font-black text-base md:text-lg px-6 md:px-8 py-3 md:py-4 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all duration-200 inline-flex items-center justify-center"
      >
        <a
