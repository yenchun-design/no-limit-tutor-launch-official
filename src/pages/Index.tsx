                ...
                <div className="overflow-x-auto" style={{ minWidth: '100%' }}>
                  <div style={{ minWidth: '1000px' }}>
                    <table className="w-full border-2 border-black bg-white text-sm relative">
                      ...
                      <tbody>
                        <tr>
                          <td className="border-2 border-black p-3 md:p-4 text-base md:text-lg font-black sticky left-0 bg-white z-10 w-20 min-w-[5rem] max-w-[5rem] break-words md:w-auto md:min-w-[8rem] md:max-w-none">No Limit Tutor</td>
                        ...
                        <tr>
                          <td className="border-2 border-black p-3 md:p-4 text-base md:text-lg font-black sticky left-0 bg-white z-10 w-20 min-w-[5rem] max-w-[5rem] break-words md:w-auto md:min-w-[8rem] md:max-w-none">平台A</td>
                        ...
                        <tr>
                          <td className="border-2 border-black p-3 md:p-4 text-base md:text-lg font-black sticky left-0 bg-white z-10 w-20 min-w-[5rem] max-w-[5rem] break-words md:w-auto md:min-w-[8rem] md:max-w-none">平台B</td>
                        ...
                        <tr>
                          <td className="border-2 border-black p-3 md:p-4 text-base md:text-lg font-black sticky left-0 bg-white z-10 w-20 min-w-[5rem] max-w-[5rem] break-words md:w-auto md:min-w-[8rem] md:max-w-none">其他多數平台</td>
