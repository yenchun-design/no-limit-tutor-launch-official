...
const Index = () => {
  ...
  const faqItems = [
    ...
    {
      question: "學生擔心被綁約或強制購買大量課程？",
      answer: "💡 平台無綁約制度，學生可自由訂閱每月所需的 4、8、12、16 堂課，彈性安排學習，並可將沒用到的課程退款。"
    },
    {
      question: "老師覺得平台不透明，學生也怕平台亂收費？",
      answer: "💡 NLT 的平台費用結構公開透明，所有收費都在付款頁清楚顯示，沒有隱藏也沒有名目費用。"
    },
    {
