...
const Index = () => {
  ...
  const faqItems = [
    ...
    {
      question: "老師如何收到課程費用？何時會撥款？",
      answer: "💡 課程結束後，學生確認完成，費用會立即進入老師帳戶。老師可隨時提領，或累積到一定金額再提領。我們採用台灣在地的綠界金流，安全又快速！"
    },
    {
      question: "如果學生 No-show 或臨時缺席怎麼辦？",
      answer: "💡 學生 No-show 且未提前 24 小時取消，老師仍會獲得該堂課的全額費用。NLT 保障老師的時間價值，讓你安心教學不吃虧！"
    },
    {
      question: "我需要什麼設備才能在 NLT 教課？",
      answer: "💡 只需要一台電腦或平板、穩定的網路連線（建議至少 10 Mbps）、麥克風和視訊鏡頭。NLT 平台會自動測試你的設備，確保上課品質！"
    },
    {
      question: "我可以自由設定課程價格嗎？",
      answer: "💡 完全可以！你可以根據自己的專業、經驗和市場行情自由定價。NLT 也會提供市場價格參考，幫助你訂定最有競爭力的價格。"
    }
  ];
  ...
  const studentFaqItems = [
    ...
    {
      question: "我需要什麼設備才能上課？",
      answer: "💡 只需要一台電腦、平板或手機，以及穩定的網路連線（建議至少 10 Mbps）。NLT 平台內建視訊教室，不需要額外下載軟體，使用瀏覽器就能輕鬆上課！"
    },
    {
      question: "如何取消或改期已預約的課程？",
      answer: "💡 您可以在課程開始前 24 小時免費取消或改期。如果是 24 小時內取消，該堂課程將被計為已使用。建議提早與老師溝通時間調整，大部分老師都很樂意配合！"
    },
    {
      question: "如果老師臨時無法上課（No-show）怎麼辦？",
      answer: "💡 如果老師未準時上課且未提前通知，該堂課程費用會全額退還給您，並且不計入您購買的課程堂數。我們也會記錄老師的 No-show 紀錄，保障您的權益。"
    },
    {
      question: "我可以同時聯繫多位老師嗎？",
      answer: "💡 當然可以！NLT 鼓勵您多方比較，找到最適合的老師。您可以同時與多位老師聊天、預約試教課程，直到找到最契合的教學夥伴。我們不會限制您的選擇自由！"
    },
    {
      question: "支援哪些付款方式？安全嗎？",
      answer: "💡 NLT 採用台灣綠界金流系統，支援信用卡、ATM 轉帳等多種付款方式。所有交易都經過加密處理，符合國際資安標準，讓您安心付款。課程費用會在平台保管，直到課程完成才撥款給老師。"
    }
  ];
...
<div className="max-w-3xl mx-auto px-4 md:px-0">
  {/* Email Form — 單一層粉黃卡片 */}
  <div className="bg-gradient-to-r from-yellow-100 to-amber-100 border-3 md:border-5 border-black shadow-[10px_10px_0_0_rgba(0,0,0,1)] md:shadow-[13px_13px_0_0_rgba(0,0,0,1)] p-6 md:p-8">
    <form onSubmit={handleEmailSubmit} className="space-y-4 md:space-y-6">
      <input
        type="email"
...
<button className="w-full h-14 md:h-16 bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 
             text-white border-3 md:border-4 border-black 
             shadow-[5px_5px_0_0_rgba(0,0,0,1)] md:shadow-[8px_8px_0_0_rgba(0,0,0,1)]
             hover:shadow-[3px_3px_0_0_rgba(0,0,0,1)] md:hover:shadow-[5px_5px_0_0_rgba(0,0,0,1)]
             font-black text-lg md:text-xl uppercase tracking-wide
            ...
            <div className="text-center mb-12 md:mb-16">
              ...
              <div className="bg-white border-4 md:border-8 border-black p-8 md:p-12 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] md:shadow-[20px_20px_0px_0px_rgba(0,0,0,1)]">
                ...
                <p className="text-xl md:text-2xl font-bold text-black">
                  我們正在招募最資深優秀的老師，成為 2026 NLT 平台首批創始成員！
                </p>
              </div>
            </div>
